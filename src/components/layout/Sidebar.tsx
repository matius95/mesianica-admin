...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 text-slate-300 flex flex-col justify-between hidden md:flex min-h-screen">
      <div>
        {/* Logo / Brand Header */}
        <div className="h-16 flex items-center px-6 border-b border-slate-800 gap-3">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-indigo-500 to-violet-500 flex items-center justify-center text-white font-bold shadow-lg shadow-indigo-500/30">
            M
          </div>
          <div>
            <h1 className="font-bold text-white text-base tracking-wide">Mesiánica Admin</h1>
            <p className="text-xs text-slate-400">Gestión de Iglesia</p>
          </div>
        </div>
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="bg-slate-800/40 rounded-xl p-3 border border-slate-800 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-medium text-white truncate">Carlos Mendoza</p>
            <p className="text-[11px] text-slate-400 truncate">Admin General</p>
          </div>
        </div>
      </div>
    </aside>
